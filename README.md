...
- **Document 섹션 편집** — DnD 정렬, 섹션별 접기/펼치기, 리사이즈
...
| # | 항목 | 요약 | 우선순위 |
|---|------|------|---------|
| 1 | Document 템플릿 프리셋 | 빈 문서/서버접속정보/API문서/프로젝트설정 등 프리셋 선택으로 빠른 생성 | P1 |
| 2 | Env 섹션 일괄 붙여넣기 | .env 파일 내용 textarea에 붙여넣기 → KEY=VALUE 자동 파싱 | P1 |
