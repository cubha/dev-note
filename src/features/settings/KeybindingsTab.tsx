    ...
    <div className="space-y-1">
      ...
      {rowError && (
        <div className="ml-[8.5rem] space-y-1">
          <p className="text-[length:var(--font-2xs)] text-[var(--text-error)]">{rowError.message}</p>
            ...
            <div className="flex flex-wrap gap-1">
              {rowError.alternatives.map((alt) => (
                <button
                  ...
                  className="rounded border border-[var(--border-default)] bg-[var(--bg-input)] px-2 py-0.5 text-[length:var(--font-2xs)] font-mono text-[var(--text-primary)] hover:bg-[var(--bg-input-hover)]"
                >
      ...
      {warnMessage && !rowError && (
        <p className="ml-[8.5rem] text-[length:var(--font-2xs)] text-[var(--text-warning)]">{warnMessage}</p>
      )}
    </div>
  )
}
