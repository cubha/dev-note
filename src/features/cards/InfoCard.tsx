        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5">
              <span
                className="text-[length:var(--font-3xs)] font-medium uppercase tracking-wider"
  ...
  return (
    <div className="px-4 pb-3 space-y-1.5">
      {content.sections.slice(0, 3).map((section) => {
        ...
        return (
          <div key={section.id} className="min-w-0">
            ...
            {summary && (
              <p className="text-[length:var(--font-2xs)] text-[var(--text-tertiary)] font-mono truncate m-0 pl-5 leading-relaxed">
      ...
      {content.sections.length > 3 && (
        <p className="text-[length:var(--font-3xs)] text-[var(--text-tertiary)] m-0 pl-5">
