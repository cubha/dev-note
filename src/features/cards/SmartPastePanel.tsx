        ...
        <div className="border-t border-[var(--border-default)] px-3 py-3 space-y-3">
          ...
          {state.errorMessage && (
            <div className="flex items-center gap-2">
              <p className="flex-1 text-[length:var(--font-3xs)] text-[var(--text-error)]">
                {state.errorMessage}
              </p>
              {state.errorDetail && (
                <button
          ...
          {hasResult && isMarkdownMode && (
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="text-[length:var(--font-3xs)] font-medium text-[var(--text-secondary)]">
                  변환 결과
                </span>
              </div>
              ...
              <div className="rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] divide-y divide-[var(--border-default)]">
                ...
                {state.suggestedTitle && (
                  <div className="flex items-center gap-2 px-3 py-1.5">
                    <span className="w-14 shrink-0 text-[length:var(--font-3xs)] text-[var(--text-secondary)]">제목</span>
                ...
                {state.fields[0]?.value && (
                  <div className="px-3 py-2">
                    <pre className="whitespace-pre-wrap text-[length:var(--font-2xs)] leading-relaxed font-mono text-[var(--text-primary)] max-h-40 overflow-y-auto m-0">
                ...
                {state.suggestedTags.length > 0 && (
                  <div className="flex items-center gap-2 px-3 py-1.5">
                    <span className="w-14 shrink-0 text-[length:var(--font-3xs)] text-[var(--text-secondary)]">태그</span>
                    <div className="flex flex-wrap gap-1">
                      {state.suggestedTags.map(tag => (
                        <span key={tag} className="rounded bg-[var(--bg-input)] px-1.5 py-0.5 text-[length:var(--font-3xs)] text-[var(--text-secondary)]">
                          {tag}
                        </span>
                      ))}
                    </div>
          ...
          {hasResult && !isDocumentMode && !isMarkdownMode && (
            <div className="space-y-2">
              ...
              <div className="rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] divide-y divide-[var(--border-default)]">
                ...
                {state.suggestedTitle && (
                  <div className="flex items-center gap-2 px-3 py-1.5">
                    <span className="w-20 shrink-0 text-[length:var(--font-3xs)] text-[var(--text-secondary)]">제목</span>
                    <span className="flex-1 truncate text-xs font-medium text-[var(--text-primary)]">
                      {state.suggestedTitle}
                    </span>
                    <Check size={12} className="shrink-0 text-[var(--text-success)]" />
                ...
                {state.fields.map((field) => (
                  <div key={field.key} className="flex items-center gap-2 px-3 py-1.5">
                    <span className="w-20 shrink-0 text-[length:var(--font-3xs)] text-[var(--text-secondary)]">{field.key}</span>
                ...
                {state.suggestedTags.length > 0 && (
                  <div className="flex items-center gap-2 px-3 py-1.5">
                    <span className="w-20 shrink-0 text-[length:var(--font-3xs)] text-[var(--text-secondary)]">태그</span>
              ...
              <div className="rounded-md border border-[var(--border-accent)] bg-[var(--bg-surface)] px-3 py-2 space-y-1">
                ...
                {state.suggestedTitle && (
                  <div className="flex items-center gap-2 pb-1 mb-1 border-b border-[var(--border-default)]">
                    <span className="text-[length:var(--font-3xs)] text-[var(--text-secondary)]">제목</span>
                ...
                {state.sections.map((s) => (
                  <div key={s.id} className="text-[length:var(--font-2xs)] text-[var(--text-tertiary)]">
                ...
                {state.suggestedTags.length > 0 && (
                  <div className="flex items-center gap-1 pt-1 mt-1 border-t border-[var(--border-default)]">
                    <span className="text-[length:var(--font-3xs)] text-[var(--text-secondary)]">태그</span>
                    <span className="text-[length:var(--font-2xs)] text-[var(--text-primary)]">{state.suggestedTags.join(', ')}</span>
                  </div>
                )}
              </div>
