        ...
        <div className="px-3 py-2 border-b border-[var(--border-default)] bg-[var(--bg-app)] space-y-2">
          ...
          <div className="flex gap-1.5">
            <button
              ...
              className="flex items-center gap-1 rounded-md bg-[var(--accent)] px-2.5 py-1 text-[length:var(--font-3xs)] font-medium text-[var(--text-on-solid)] hover:bg-[var(--accent-hover)] disabled:opacity-50 disabled:cursor-not-allowed border-none cursor-pointer transition-colors"
            >
            ...
            <button
              ...
              className="rounded-md px-2.5 py-1 text-[length:var(--font-3xs)] text-[var(--text-secondary)] hover:bg-[var(--bg-surface-hover)] cursor-pointer bg-transparent border-none transition-colors"
            >
              취소
            </button>
          </div>
