...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    version: 'v2.2.2',
    date: '2026-09-10',
    title: '바꾸기가 다음 결과로 넘어갑니다',
    highlights: [
      '바꾸기를 누르면 다음 결과로 이동합니다 — 같은 자리가 계속 바뀌던 문제를 고쳤습니다',
      '한 번 누르면 한 건만 바뀝니다',
      '결과로 이동할 때 미리보기·MD변환·접어둔 메모가 자동으로 열립니다',
      '화면에 보이지 않는 칸은 바꾸기 대상에서 빠집니다',
      '찾기 창을 열어둔 채 편집한 내용이 되돌아가지 않습니다',
      '작게 지정된 글자(뱃지·라벨·찾기 입력창 등)가 실제 크기로 표시됩니다',
    ],
    type: 'patch',
  },
  {
    ...
    title: '카드 전체에서 찾기',
    highlights: [
      'Ctrl+F가 카드 하나를 통째로 찾습니다 — 섹션이 여러 개여도 결과가 한 곳에 모입니다',
      '접혀 있는 섹션의 결과로 이동하면 그 섹션이 자동으로 펼쳐집니다',
  ...
  },
  {
    ...
    highlights: [
      '탭을 우클릭하거나 카드의 ⋯ 메뉴, 사이드바 항목 우클릭에서도 카드를 md 파일로 저장할 수 있습니다',
      '사이드바에서 카드를 여러 개 선택하면 나타나는 액션바가 파란 패널로 바뀌어 눈에 잘 띕니다',
      '사이드바를 좁게 줄여도 액션바의 버튼 글자가 중간에서 잘리거나 접히지 않습니다',
      'md 저장에 실패하면 아무 반응 없이 끝나지 않고 실패 안내가 표시됩니다',
    ],
    type: 'patch',
  },
  {
