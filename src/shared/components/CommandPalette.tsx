    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2 border-b border-[var(--border-default)] px-4 py-3">
          ...
          />
          <kbd className="rounded border border-[var(--border-default)] px-1.5 py-0.5 text-[length:var(--font-3xs)] text-[var(--text-tertiary)]">
            ESC
          </kbd>
        </div>
            ...
            filtered.map((cmd, i) => (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <span className="rounded bg-[var(--bg-input)] px-1.5 py-0.5 text-[length:var(--font-3xs)] text-[var(--text-tertiary)] shrink-0">
                    {CATEGORY_LABELS[cmd.category] ?? cmd.category}
                  </span>
                  <span className="truncate">{cmd.label}</span>
                </div>
                {cmd.shortcut && (
                  <kbd className="shrink-0 rounded border border-[var(--border-default)] px-1.5 py-0.5 text-[length:var(--font-3xs)] text-[var(--text-tertiary)]">
                    {cmd.shortcut}
                  </kbd>
                )}
              </li>
